...
@NamedQueries({
    @NamedQuery(name = "OrgDepartment.findAll", query = "SELECT o FROM OrgDepartment o")})
...
//    private List<OrgEmployee> orgEmployeeList;
    ...
    public OrgDepartment(OrgCompany orgCompany, String code, String name, boolean activation, OrgDepartment parent) {
    ...
    public OrgDepartment(Long id, String code, String name, boolean activation) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.activation = activation;
...
//    }
    ...
    public void setParent(OrgDepartment parent) {
        this.parent = parent;
    }
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrgDepartment)) {
            return false;
        }
        OrgDepartment other = (OrgDepartment) object;
    ...
    public String toString() {
        return "com.tcci.fc.entity.org.OrgDepartment[ id=" + id + " ]";
    }
