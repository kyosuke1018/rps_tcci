...
import com.tcci.fc.event.content.ContentHolderEvent;
...
public abstract class AbstractFacade<T> {
    ...
    Event<ContentHolderEvent> contentHolderEvent;
    ...
    public void remove(T entity) {
        ...
        if (entity instanceof ContentHolder) {
            ContentHolderEvent event = new ContentHolderEvent();
            event.setContentHolder((ContentHolder)entity);
            contentHolderEvent.fire(event);
        }
    }
