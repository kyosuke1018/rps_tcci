...
public class BPMTemplateFacade {
    ...
    private TcProcesstemplate wrapperProcessTemplate(ProcesstemplateConverter p,String processversion, boolean disabled){
        ...
        processtemplate.setDisabled(disabled);
    ...
    private TcActivitytemplate wrapperActivityTemplate(ActivitytemplateConverter at,TcProcesstemplate processtemplate){
        ...
        activitytemplate.setDuration(at.getDuration());
