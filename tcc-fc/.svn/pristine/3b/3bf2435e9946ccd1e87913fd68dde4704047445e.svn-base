...
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (5,'neo.fu','傅柏貴',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (6,'wayne.hu','胡憲維',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (7,'edwin.ho','何炎運',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (8,'yen-chi.sun','孫延麒',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (9,'david.jen','任大為',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (10,'kyle.cheng','鄭傑鳴',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (11,'peter.pan','潘倫政',0,1,SYSDATE);
