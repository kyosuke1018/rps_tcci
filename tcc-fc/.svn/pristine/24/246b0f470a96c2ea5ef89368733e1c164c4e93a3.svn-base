...
//            String loginAccount = ManagedBeanUtil.getUserAccount();
            String loginAccount = "gilbert.lin";//hard code
            TcUser tcUser = tcUserFacade.getTcUserListByLoginAccount(loginAccount);
            fvItem.setCreator(tcUser.getId());
            ...
            applicationData.setCreator(tcUser.getId());
...
//            System.out.println("id="+ObjectId);
    ...
    public void removeByContainerId(ContentHolder container, ContentRole contentRole) throws Exception {
        List<TcApplicationdata> apppList = tcApplicationdataFacade.getByContentHolder(container, contentRole);
