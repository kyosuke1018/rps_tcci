...
public class FileUploadFacade extends AbstractFacade<TcFvitem> {
    ...
    public TcApplicationdata uploadContent(TcDomain domain, ContentHolder container, InputStream inputstream, String uploadedFileName, long filesize, String contenttype, ContentRole contentRole, TcUser creator) throws Exception {
        return uploadContent(domain, container, inputstream, uploadedFileName, filesize, contenttype, contentRole, "", creator);
    }
    ...
    public TcApplicationdata uploadContent(TcDomain domain, ContentHolder container, InputStream inputstream, String uploadedFileName, long filesize, String contenttype, ContentRole contentRole, String description) throws Exception {
        ...
        TcUser sessionUser = null;
        String loginAccount = null;
        if (principal != null) {
            loginAccount = principal.getName();
        }
        if (loginAccount != null) {
            sessionUser = tcUserFacade.findUserByLoginAccount(loginAccount);
        }
        return uploadContent(domain, container, inputstream, uploadedFileName, filesize, contenttype, contentRole, description, sessionUser);
    }
     ...
     * @throws Exception
     */
    public TcApplicationdata uploadContent(TcDomain domain, ContentHolder container, InputStream inputstream,
            String uploadedFileName, long filesize, String contenttype, ContentRole contentRole, String description, TcUser creator) throws Exception {
//        System.out.println("uploadContent");
        ...
        try {
            ...
            applicationData.setCreator(creator);
            ...
            //bug fixed: 未更新 fvItem 的 tcApplicationCollection 屬性會造成 vault
            List<TcApplicationdata> applicationdatas = new ArrayList();
            applicationdatas.add(applicationData);
            fvItem.setTcApplicationdataCollection(applicationdatas);
            em.merge(fvItem);
        } catch (Exception e) {
//            e.printStackTrace();
