...
CREATE TABLE  TC_URLDATA (
  ...
  CONTENTROLE VARCHAR2(255) DEFAULT NULL,
...
COMMENT ON COLUMN tc_urldata.ID IS 'APPLICATIONDATA.ID';
/
COMMENT ON COLUMN tc_urldata.CONTAINERCLASSNAME IS 'entity name(ex. com.tcci.hep.entity.LEAVE)';
/
COMMENT ON COLUMN tc_urldata.CONTAINERID IS 'entity ID(ex. LEAVE.ID)';
/
COMMENT ON COLUMN tc_urldata.CONTENTROLE IS 'Primary:P,Secondary:S';
/
COMMENT ON COLUMN tc_urldata.CREATOR IS '建立者 (FK:TC_USER.ID)';
/
COMMENT ON COLUMN tc_urldata.CREATETIMESTAMP IS '建立時間';
/
COMMENT ON COLUMN tc_urldata.url IS '網址';
/
COMMENT ON COLUMN tc_urldata.DESCRIPTION IS '說明';
/
...
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (12,'kyle.cheng','鄭傑鳴',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (13,'peter.pan','潘倫政',0,1,SYSDATE);
...
Insert into TC_USERGROUP (ID,USER_ID,GROUP_ID,CREATOR,CREATETIMESTAMP) values (12,12,1,1,sysdate);
Insert into TC_USERGROUP (ID,USER_ID,GROUP_ID,CREATOR,CREATETIMESTAMP) values (13,13,1,1,sysdate);
commit;
/