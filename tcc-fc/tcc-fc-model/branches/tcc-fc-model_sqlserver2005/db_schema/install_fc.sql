...
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (1,'administrator',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (2,'jimmy.lee',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (3,'jason.yu',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (4,'greg.chou',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (5,'gilbert.lin',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (6,'jackson.lee',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (7,'louisz.cheng',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (8,'lynn.huang',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (9,'jason.chang',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (10,'neo.fu',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (11,'wayne.hu',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,DISABLED,CREATOR,CREATETIMESTAMP) VALUES (12,'edwin.ho',0,1,SYSDATE);
