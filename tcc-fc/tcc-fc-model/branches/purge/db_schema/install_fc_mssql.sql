...
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES ('sam.lin',N'ªL©[¾Ë',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES ('yen-chi.sun',N'®]©µÄQ',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES ('david.jen',N'¥ô¤j¬°',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES ('kyle.cheng',N'¾G³Ç¶ã',0,1,SYSDATE);
INSERT INTO TC_USER (ID,LOGIN_ACCOUNT,CNAME,DISABLED,CREATOR,CREATETIMESTAMP) VALUES ('peter.pan',N'¼ï­Û¬F',0,1,SYSDATE);
