        ...
        try {
            ...
            while (st.hasMoreElements()) {
                ...
                if (tableTitle != null && !tableTitle.isEmpty() && !tableId.contains("" + ",")) {
                    ...
                    Font tableTitleFont = new Font(bf, Font.DEFAULTSIZE, Font.BOLD);
                    //---End---tcc customized.
...
//                        }
    ...
    protected void exportCells(DataTable table, PdfPTable pdfTable) {
        for (UIColumn col : table.getColumns()) {
            ...
            if (col.isExportable()) {
                ...
                addColumnValue(pdfTable, col, col.getChildren(), this.cellFont, "data");
            }
        ...
        for (UIColumn col : table.getColumns()) {
            ...
            if (col.isExportable()) {
                if (col.getHeaderText() != null && columnType.name().equalsIgnoreCase("header")) {
                    ...
                    addColumnValue(pdfTable, col, col.getFacet(columnType.facet()), this.facetFont, columnType.name());
                }
            }
        }
    }
    ...
    protected void addColumnValue(PdfPTable pdfTable, UIColumn column, UIComponent component, Font font, String columnType) {
    ...
    protected void addColumnValue(PdfPTable pdfTable, UIColumn column, List<UIComponent> components, Font font, String columnType) {
        StringBuilder builder = new StringBuilder();
