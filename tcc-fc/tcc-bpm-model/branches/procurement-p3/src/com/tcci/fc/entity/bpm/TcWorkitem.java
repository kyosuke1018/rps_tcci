...
public class TcWorkitem implements Serializable {
    ...
    private List<TcSignature> tcSignatureCollection;
    ...
    public List<TcSignature> getTcSignatureCollection() {
        return tcSignatureCollection;
    }

    public void setTcSignatureCollection(List<TcSignature> tcSignatureCollection) {
