...
public class BPMEngineImpl implements IBPMEngine {
    ...
    public List<TcWorkitem> myRunningWorkitems(TcUser owner, Class clazz) {
        return engineFacade.myRunningWorkitems(owner, clazz);
    }

    @Override
    public List<TcWorkitem> myRunningWorkitems(TcUser owner, String processname) {
        return engineFacade.myRunningWorkitems(owner, processname);
    }
    ...
    public List<TcWorkitem> allRunningWorkitems(Class clazz) {
        return engineFacade.allRunningWorkitems(clazz);
    }

    @Override
    public List<TcWorkitem> allRunningWorkitems(String processname) {
        return engineFacade.allRunningWorkitems(processname);
    }
    ...
    public void batchNotifyRunningWorkitems() {
        Map<TcUser, List<TcWorkitem>> mapUserItems = mapUserToWorkitems(allRunningWorkitems());
    ...
    public void batchNotifyRunningWorkitems(Class clazz) {
        Map<TcUser, List<TcWorkitem>> mapUserItems = mapUserToWorkitems(allRunningWorkitems(clazz));
        for (Map.Entry<TcUser, List<TcWorkitem>> entry : mapUserItems.entrySet()) {
            try {
                onBatchNotifyRunningWorkitems(entry.getKey(), entry.getValue(), clazz);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
    ...
    public void onBatchNotifyRunningWorkitems(TcUser owner, List<TcWorkitem> workitems, Class clazz) {
        System.out.println(owner.getCname() + "有下列申請單待簽核, Class=" + clazz.getCanonicalName());
        for (TcWorkitem workitem : workitems) {
            StringBuilder sb = new StringBuilder();
            sb.append("id:").append(workitem.getId())
              .append(", ").append(workitem.getActivityname())
    ...
    public void batchNotifyRunningWorkitems(String processname) {
        Map<TcUser, List<TcWorkitem>> mapUserItems = mapUserToWorkitems(allRunningWorkitems(processname));
        for (Map.Entry<TcUser, List<TcWorkitem>> entry : mapUserItems.entrySet()) {
            try {
                onBatchNotifyRunningWorkitems(entry.getKey(), entry.getValue(), processname);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
    ...
    public void onBatchNotifyRunningWorkitems(TcUser owner, List<TcWorkitem> workitems, String processname) {
        System.out.println(owner.getCname() + "有下列申請單待簽核, processname=" + processname);
        for (TcWorkitem workitem : workitems) {
            StringBuilder sb = new StringBuilder();
            sb.append("id:").append(workitem.getId())
              .append(", ").append(workitem.getActivityname())
    ...
    private Map<TcUser, List<TcWorkitem>> mapUserToWorkitems(List<TcWorkitem> workitems) {
