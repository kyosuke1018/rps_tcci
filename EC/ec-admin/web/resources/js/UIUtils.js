...
function scrollDivToY(id, y){
    if( isNA(id) ){
        window.scrollTo(0, y);
    }else{
        var objDiv = document.getElementById(id);
        objDiv.scrollTop = y<0?objDiv.scrollHeight:y;// y 小於零表示到底部
    }
}
...
function moveDatatable(toRight){
    ...
    var selectorStr = "div.ui-datatable-scrollable-body";// 所有 dataTable // PF6.X (datatable scrollable="true")
