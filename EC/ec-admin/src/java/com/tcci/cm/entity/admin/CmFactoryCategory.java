...
import com.tcci.fc.util.EntityComparator.OrderTypeEnum;
...
@NamedQueries({
    ...
    @NamedQuery(name = "CmFactoryCategory.findById", query = "SELECT a FROM CmFactoryCategory a WHERE a.id = :id"),})
