...
public class MenuFunctionVO implements IPresentationVO, Comparable, Serializable {
    ...
    private int feedbackStep;// 回饋關數 3
    // int scoreRptDate;// 扣考報表產出日 4
    private int scorePreMonth;// 扣考報表產出月(前幾月) 1
    // int scoreRptPeriod;// 扣考報表區間類型(by D、M)
    
    private boolean light; // 支援燈號(0:無; 1:有)
    private boolean score;// 有無支援扣考(0:無; 1:有)
    private int scoreDeduction;// 扣分
