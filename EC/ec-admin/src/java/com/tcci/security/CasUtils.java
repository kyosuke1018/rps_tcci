...
public class CasUtils {
    ...
    public static String constructRedirectUrl(HttpServletRequest request, HttpServletResponse response, Properties jndiConfig){
        ...
        String casServerLoginUrl = SecurityUtils.getFromSysProps(SecurityConstants.SP_CAS_LOGIN, SecurityConstants.DEF_CAS_LOGIN);
        casServerLoginUrl = SecurityUtils.getFromJNDI(jndiConfig, SecurityConstants.PN_CAS_LOGIN, casServerLoginUrl);
