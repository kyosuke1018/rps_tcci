...
function UGFunctions(){
	...
	/**
	 * get size and position of some objecttop = parentSize.height
	 */
	this.getElementSize = function(element){
		...
		var obj = element.position();
                // unitegallery.js:601 Uncaught TypeError: Cannot set property 'height' of undefined
                //console.log("peter add obj = \n", obj);
                //console.log("peter add element = \n", element);
		if( obj !== undefined ){// peter update
	...
	this.placeElement = function(element, left, top, offsetLeft, offsetTop, objParent){
		...
		if(jQuery.isNumeric(top) == false){
                    if( parentSize !== undefined ){// peter add
			switch(top){
				case "top":
					top = 0;
					if(offsetTop)
