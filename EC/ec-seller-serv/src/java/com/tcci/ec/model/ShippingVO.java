...
public class ShippingVO implements Serializable {
    ...
    public ShippingVO(Long id, Boolean active) {
        this.id = id;
        this.active = active;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ShippingVO)) {
            return false;
        }
        ShippingVO other = (ShippingVO) object;
    ...
    public String toString() {
        return "com.tcci.ec.model.ShippingVO[ id=" + id + " ]";
    }
