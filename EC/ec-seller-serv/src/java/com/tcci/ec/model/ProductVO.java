...
public class ProductVO extends BaseResponseVO implements Serializable {
    ...
    @ExcelFileFieldMeta(exportIndex = 9, dataType = DataTypeEnum.DATETIME, headerName = "上架時間")
    private Date publishTime;
    @InputCheckMeta(key="EC_PRODUCT.PUBLISH_SCOPE")
    private String publishScope;
    private Long creatorId;
    @ExcelFileFieldMeta(exportIndex = 10, dataType = DataTypeEnum.DATETIME, headerName = "建立時間")
    private Date createtime;
    private Long modifierId;
    @ExcelFileFieldMeta(exportIndex = 11, dataType = DataTypeEnum.DATETIME, headerName = "最近修改時間")
    ...
    public String genUrl(String urlRoot, String path, String imgType){
        ...
        qstr.append("?publicImg=Y&contentType=").append(contentType)
                ...
                // EC1.5 台泥商品共用照片
                .append("&imgSrc=").append((tccPrd!=null && tccPrd)?FileEnum.TCC_PRD_PIC.getCode():FileEnum.PRD_PIC.getCode());
        if( storeId!=null ){
