...
public class OrderVO15 extends BaseResponseVO implements Serializable {
    ...
    @ExcelFileFieldMeta(exportIndex = 2, dataType = DataTypeEnum.STRING, headerName = "出貨狀態")
    private String shipStatusLabel;

    @ExcelFileFieldMeta(exportIndex = 3, dataType = DataTypeEnum.STRING, headerName = "編號")
    @InputCheckMeta(key="EC_ORDER.ORDER_NUMBER")
    private String orderNumber;

    @InputCheckMeta(key="EC_ORDER.PAYMENT_TYPE")
    private String paymentType;
    @ExcelFileFieldMeta(exportIndex = 4, dataType = DataTypeEnum.DATETIME, headerName = "訂單時間")
    private Date approvetime;
    private Date shippingTime;
    // EC1.0 只有單筆 DETAIL
    //@ExcelFileFieldMeta(exportIndex = 5, dataType = DataTypeEnum.INT, headerName = "商品筆數")
    private Integer itemCount;// 商品筆數
    @ExcelFileFieldMeta(exportIndex = 5, dataType = DataTypeEnum.STRING, headerName = "商品名稱")
    private String productName;
    private String productCode;
    private Long productId;
    
    @ExcelFileFieldMeta(exportIndex = 6, dataType = DataTypeEnum.BIG_DECIMAL, headerName = "報價總金額")
    private BigDecimal total;
    @ExcelFileFieldMeta(exportIndex = 7, dataType = DataTypeEnum.BIG_DECIMAL, headerName = "原商品總價")
    private BigDecimal subTotal;
    @ExcelFileFieldMeta(exportIndex = 8, dataType = DataTypeEnum.BIG_DECIMAL, headerName = "運費")
    ...
    @ExcelFileFieldMeta(exportIndex = 9, dataType = DataTypeEnum.STRING, headerName = "幣別")
    ...
    @ExcelFileFieldMeta(exportIndex = 11, dataType = DataTypeEnum.STRING, headerName = "聯絡電話")
    private String tel1;
    private String tel2;
    @ExcelFileFieldMeta(exportIndex = 12, dataType = DataTypeEnum.STRING, headerName = "聯絡E-Mail")
    private String email1;
    private String email2;

    //@ExcelFileFieldMeta(exportIndex = 13, dataType = DataTypeEnum.STRING, headerName = "付款方式")
    //private String payment;// 付款方式
    @ExcelFileFieldMeta(exportIndex = 13, dataType = DataTypeEnum.STRING, headerName = "出貨方式")
    private String shipping;// 運送方式
    private String payCode;// PayMethodEnum.code
    private String payType;// PayMethodEnum.type
    
    //@ExcelFileFieldMeta(exportIndex = 14, dataType = DataTypeEnum.STRING, headerName = "備註事項")
    ...
    public OrderVO15(Long id) {
        this.id = id;
    }

    public OrderVO15(Long id, Long storeId, String orderNumber, BigDecimal total, BigDecimal subTotal, BigDecimal shippingTotal, BigDecimal discountTotal, String status) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OrderVO15)) {
            return false;
        }
        OrderVO15 other = (OrderVO15) object;
    ...
    public String toString() {
        return "com.tcci.ec.model.OrderVO15[ id=" + id + " ]";
    }
