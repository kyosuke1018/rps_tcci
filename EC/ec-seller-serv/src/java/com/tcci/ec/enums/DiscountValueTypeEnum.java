...
public enum DiscountValueTypeEnum {
    ...
    DiscountValueTypeEnum(String code, String name){
        this.code = code;
        this.name = name;
    }
    
    public static DiscountValueTypeEnum getFromCode(String code){
        for (DiscountValueTypeEnum enum1 : DiscountValueTypeEnum.values()) {
