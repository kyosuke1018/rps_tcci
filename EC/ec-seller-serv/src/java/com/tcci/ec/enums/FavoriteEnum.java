...
public enum FavoriteEnum {
    CAR_NO("carNo", "送達地點"),
    DELIVERY_ID("deliveryId", "送達地點")
    ;
    
    private String code;
    private String name;
    
    FavoriteEnum(String code, String name){
        this.code = code;
        this.name = name;
    }
    
    public static FavoriteEnum getFromCode(String code){
        for (FavoriteEnum enum1 : FavoriteEnum.values()) {
