...
public enum OptionEnum {
    ...
    ,PRD_UNIT_DEF("prdUnitSys", "系統預設商品計價單位", ProductUnitEnum.class, null, false)
    ,CREDIT_STATUS("creditStatus", "信用額度", CusCreditEnum.class, null, false)
    ...
    ,DEALERS("dealers", "台泥經銷商", null, "EC_MEMBER", false)
    ,FAV_CARNO("favCars", "常用車號", null, "EC_CUS_ADDR", true)
    ...
    ,SALES_AREA("salesArea", "銷售區域/所在區域", null, "EC_OPTION", false)
