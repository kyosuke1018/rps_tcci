...
public enum MessageCategoryEnum {
    ...
    MessageCategoryEnum(String code, String name){
        this.code = code;
        this.name = name;
    }
    
    public static MessageCategoryEnum getFromCode(String code){
        for (MessageCategoryEnum enum1 : MessageCategoryEnum.values()) {
