...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(com.tcci.ec.facade.rs.CustomerREST.class);
        resources.add(com.tcci.ec.facade.rs.MemberREST.class);
        resources.add(com.tcci.ec.facade.rs.OptionsREST.class);
        resources.add(com.tcci.ec.facade.rs.OrderREST.class);
        resources.add(com.tcci.ec.facade.rs.ProductREST.class);
        resources.add(com.tcci.ec.facade.rs.StatisticREST.class);
        resources.add(com.tcci.ec.facade.rs.StoreREST.class);
        resources.add(com.tcci.ec.facade.rs.SystemREST.class);
        resources.add(com.tcci.ec.facade.rs.VendorREST.class);
