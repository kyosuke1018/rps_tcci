...
@NamedQueries({
    ...
    , @NamedQuery(name = "EcFavoriteStore.findById", query = "SELECT e FROM EcFavoriteStore e WHERE e.id = :id")
    , @NamedQuery(name = "EcFavoriteStore.findByCreatetime", query = "SELECT e FROM EcFavoriteStore e WHERE e.createtime = :createtime")
    , @NamedQuery(name = "EcFavoriteStore.findByModifytime", query = "SELECT e FROM EcFavoriteStore e WHERE e.modifytime = :modifytime")})
public class EcFavoriteStore implements Serializable {
    ...
    public String toString() {
        return "com.tcci.ec.entity.EcFavoriteStore[ id=" + id + " ]";
    }
