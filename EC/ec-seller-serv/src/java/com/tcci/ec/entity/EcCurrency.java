...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EcCurrency.findAll", query = "SELECT e FROM EcCurrency e")
    , @NamedQuery(name = "EcCurrency.findById", query = "SELECT e FROM EcCurrency e WHERE e.id = :id")
    , @NamedQuery(name = "EcCurrency.findByCode", query = "SELECT e FROM EcCurrency e WHERE e.code = :code")})
public class EcCurrency implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EcCurrency)) {
            return false;
        }
        EcCurrency other = (EcCurrency) object;
    ...
    public String toString() {
        return "com.tcci.ec.entity.EcCurrency[ id=" + id + " ]";
    }
