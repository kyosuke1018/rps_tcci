...
@NamedQueries({
    ...
    , @NamedQuery(name = "EcPayment.findById", query = "SELECT e FROM EcPayment e WHERE e.id = :id")})
public class EcPayment implements Serializable {
    ...
    @InputCheckMeta(key="EC_PAYMENT.TITLE")
    @Column(name = "TITLE")
    private String title;
    @InputCheckMeta(key="EC_PAYMENT.DESC")
    @Column(name = "MEMO")
    private String memo;
    @InputCheckMeta(key="EC_PAYMENT.TYPE")
    @Column(name = "TYPE")
    private String type;
    @Basic(optional = false)
    @Column(name = "ACTIVE")
