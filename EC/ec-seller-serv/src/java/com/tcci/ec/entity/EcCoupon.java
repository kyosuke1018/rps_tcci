...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EcCoupon.findAll", query = "SELECT e FROM EcCoupon e")
    , @NamedQuery(name = "EcCoupon.findById", query = "SELECT e FROM EcCoupon e WHERE e.id = :id")})
public class EcCoupon implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EcCoupon)) {
            return false;
        }
        EcCoupon other = (EcCoupon) object;
    ...
    public String toString() {
        return "com.tcci.ec.entity.EcCoupon[ id=" + id + " ]";
    }
