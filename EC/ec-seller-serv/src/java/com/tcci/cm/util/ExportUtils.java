...
public class ExportUtils {
    ...
    public final static String FONT_EXCEL_DEF = "Serif"; // 確保 autoSizeColumn 有效 (Serif、Sans-serif、Monospaced、Dialog、DialogInput)
    public final static int BASE_WIDTH = 512;
    public final static int MIN_COL_WIDTH = 512 * 3;
    public final static int MAX_COL_WIDTH = 512 * 16;
    ...
    public static void formatExcel(Workbook document, 
        ...
        // Header 文字過濾
        processHeader((HSSFWorkbook) document, sheetIndex, highLightColumns, 0, headerRowNum);
    ...
    public static void formatExcelOnlyString(Workbook document, int sheetIndex, Map<Integer, Integer> colsWidth, boolean removeLastRow){
        formatExcel(document, sheetIndex, colsWidth, null, null, null, null, null, removeLastRow, 1);
    }
    ...
    public static InputStream saveWorkbookToInputStream(Workbook workbook, String fileName) throws IOException {
        ...
        String fullname =  savepath + GlobalConstant.FILE_SEPARATOR + "TMP_" + UUID.randomUUID().toString() + "_" + fileName;
    ...
    public static void formatXlsStyle(HSSFWorkbook wb
        ...
        for(int r=startRow; r<rows; r++){ //掃描所有的Row取得資料 (header除外)
            HSSFRow row = sheet.getRow(r);
