...
public class GlobalConstant {
    ...
    // 功能開關
    public static final boolean SESSION_KEY_ENABLED = true;// 增加自訂 session key 保護
    ...
    public static final boolean SHIP_QUANTITY_MODIFY = false;// 確認出貨時可改量
    ...
    public static final String PO_IN_BUYER_CHECK = "BUYER_CHECK";// 待買家確認訂單量、價
    
    public static final int MAX_STORE_NUM = 10; // 單一賣家最大商店數
    public static final int MAX_CUS_FAVORITES =5;// 客戶常用設定最大筆數
    ...
    public static final String SECURITY_KEY_EC10 = "YJ&^%h12j7H*#%TFV*BFJUA5ry&134dfb326efe*@!$s6";// for EC1.0
    //  Seller Security
    ...
    public static final String DEF_PWD = "abcd1234";
    ...
    public static final String NOTIFY_ADMIN_EMAIL = "peter.pan@tcci.com.tw";// utils 中Exception通知EMAIL
    // jndi/global
    public static final String JNDI_DOCPUB_URL = "DOCPUB_URL";
    
    // restful
    public static final String EMAIL_SUBJECT_PREFIX = "【EC2.0】";// EMAIL 主旨前置詞
