...
public class DateFormatUtils extends
    ...
    */
    ...
    public static final FastDateFormat SIMPLE_YEAR_MONTH_FORMAT = FastDateFormat.getInstance("yyyyMM");
    public static final FastDateFormat SIMPLE_YYMM_FORMAT = FastDateFormat.getInstance("yyyy/MM");
    
    public static final FastDateFormat SIMPLE_DATE_FORMAT = FastDateFormat.getInstance("yyyyMMdd");
    
     public static final FastDateFormat SIMPLE_ISO_DATETIME_FORMAT_WITH_DASH = FastDateFormat.getInstance("yyyy-MM-dd-HH-mm-ss");
}
