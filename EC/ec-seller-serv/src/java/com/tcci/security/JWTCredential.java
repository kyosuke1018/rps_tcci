...
public class JWTCredential implements Credential {
    ...
    public JWTCredential(String caller, String password, boolean encrypted, String from){
       this.caller = caller;
    ...
    public JWTCredential(String caller, Set<String> authorities, Long memberId, Long storeId, 
