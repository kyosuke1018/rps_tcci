...
//        }
//    }
    public void save(EcStoreUser entity, EcMember operator){
        if( entity!=null ){
            if( entity.getId()!=null && entity.getId()>0 ){
                entity.setModifier(operator);
                entity.setModifytime(new Date());
    ...
    public EcStoreUser findByMember(Long memberId){
        Map<String, Object> params = new HashMap<>();
        params.put("memberId", memberId);
        
        List<EcStoreUser> list = this.findByNamedQuery("EcStoreUser.findByMember", params);
