...
//        }
//    }
    public void save(EcPrdDetail entity) {
    ...
    public List<PrdDetailVO> findByCriteria(BaseCriteriaVO criteriaVO){
        ...
        sql.append("SELECT S.*, F.NAME TITLE, F.SAVEDIR, F.SAVENAME, F.FILENAME, F.CONTENT_TYPE FILECONTENTTYPE \n");
...
//                vo.setUrl(vo.genUrl("", GlobalConstant.URL_GET_IMAGE, "O"));
                vo.setUrl(vo.genUrl("", prefix+GlobalConstant.URL_GET_IMAGE, "O"));
            }
        }
        return list;
    }
