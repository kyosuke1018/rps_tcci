...
@NamedQueries({
    ...
    , @NamedQuery(name = "EcCompany.findByMainId", query = "SELECT e FROM EcCompany e WHERE e.mainId = :mainId AND e.type = :type")
    , @NamedQuery(name = "EcCompany.findByStore", query = "SELECT e FROM EcCompany e WHERE e.type = 'S' AND e.mainId = :storeId")})
