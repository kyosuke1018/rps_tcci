...
public class NativeSQLUtils {
     ...
     * @return
     */
    public static String getNotInSQL(String pColumnName, List pValueList, Map<String, Object> params) {
        int startIdx = 1;
        String prefixChar = "#";
        boolean doAnd = true;
        boolean isIn = false;
    ...
    public static String getNotInSQL(String pColumnName, List pValueList, Map<String, Object> params, int startIdx) {
        String prefixChar = "#";
        boolean doAnd = true;
        boolean isIn = false;
        return SQLUtils.getInSQL(pColumnName, pValueList, params, startIdx, prefixChar, doAnd, isIn);
