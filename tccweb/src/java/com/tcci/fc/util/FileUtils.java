...
public class FileUtils extends org.apache.commons.io.FileUtils{
    ...
    public static String getFileName(String fileAndPath) {
        int i = fileAndPath.lastIndexOf(File.separator);
        i = (i==-1)? fileAndPath.lastIndexOf("\\"):i;
        return fileAndPath.substring(i+1);
    }
    public static String getFileNameNoExt(final File file) {
