...
public class StringUtils extends org.apache.commons.lang.StringUtils {
     ...
     * @return 
     */
    public static boolean containsZh(String src, String key){
        if( src==null || src.isEmpty() || key==null ){
            return false;
        }
        String[] keys = converterZhCode(key);
        return containsZh(src, keys);
    }
    public static boolean containsZh(String src, String[] keys){
    ...
    /**
     * use for entity print debug message
     * @param msg 
     */
    public static void printLog(String msg){
        logger.info("StringUtils printLog msg = "+msg);
    }
    ...
    public static String trimRight(String sSource) {
        return trimChars(sSource, ' ', false);
    }
    public static String trimChars(String sSource, char trimChar, boolean left) {
        if (sSource == null) {
            return "";
        }
    ...
    public static int nullSafeStringComparator(final String one, final String two) {
        logger.info("nullSafeStringComparator one = "+one+"; two = "+two);
