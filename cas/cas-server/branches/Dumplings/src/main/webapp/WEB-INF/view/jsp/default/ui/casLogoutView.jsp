                ...
                <div id="login">
                    <div style="position:relative;">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <div id="message" class="right" style="background-color:white;height:138px; width:275px; opacity:0.85;border-bottom-left-radius:10px; border-bottom-right-radius:10px;">
