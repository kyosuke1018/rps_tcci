...
function m_lowCaseConverter() {
	//alert('lowCaseConverter');
    var jid = document.getElementById("m_username");
	//alert(jid);
    var data = jid.value;
    jid.value = data.toLowerCase().trim();
	//alert(jid);
    jid = document.getElementById("m_password");
    data = jid.value;
    jid.value = data.trim();
    return true;
}
...
function m_usernameConverter() {
//    alert('usernameConverter');
    var companyCode = document.getElementById("m_companyCode").value;
    //alert('m_companyCode=' + companyCode);
	var username=document.getElementById("m_username").value;
	//alert('username='+username);
    if (companyCode !== '') {
		//alert('combine');
        document.getElementById("m_username").value = username + "@" + companyCode;
    }
//    alert('password=' + document.getElementById('password').value);
    return true;
}
