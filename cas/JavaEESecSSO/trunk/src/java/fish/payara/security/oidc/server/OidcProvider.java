 ...
 * Microsoft Azure AD: https://login.windows.net/common/.well-known/openid-configuration
...
public class OidcProvider {
    ...
    /**
     *  http://localhost:8080/JavaEESecSSO/resources/oidc-provider/.well-known/openid-configuration
     * @return
     */
    ...
    public Response getConfiguration() {
        ...
        try (InputStream inputStream = classLoader.getResourceAsStream("openid-configuration.json")) {
            ...
            LOG.error("getConfiguration IOException:\n", ex);
        }
    ...
    /**
     * http://localhost:8080/JavaEESecSSO/resources/oidc-provider/auth
     * @param clientId
     * @param scope
     * @param responseType
     * @param nonce
    ...
    /**
     *  http://localhost:8080/JavaEESecSSO/resources/oidc-provider/token
     * @param clientId
     * @param clientSecret
     * @param grantType
     * @param code
    ...
    public Response tokenEndpoint(
        ...
        if (!CLIENT_ID_VALUE.equals(clientId)) {
            ...
            JWTClaimsSet jwtClaims = new JWTClaimsSet.Builder()
                    .issuer("http://localhost:8080/JavaEESecSSO/resources/oidc-provider")
    ...
    /**
     *  http://localhost:8080/JavaEESecSSO/resources/oidc-provider/userinfo
