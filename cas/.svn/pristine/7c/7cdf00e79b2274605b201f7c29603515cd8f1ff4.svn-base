    ...
    <html>
        <head>
            ...
            <script type="text/javascript">
                ...
                $(window).on('resize', $.debounce(100, resize2));
                $(function ()
                {
                    resize2();
        ...
        <body>
            <div class="background">
                ...
                <div class="login">
                    <div class="tcc tab" style="width: 380px;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td style="padding: 0px 0px 5px 8px;">
                                    <div id="image" class="left" style="height:112px;width:50px;">
                                        <img src="./images/confirm.gif"/>
                                    </div>
                                </td>
                                <td style="padding: 0px 5px 5px 0px;">
                                    <div id="message" class="right" style="height:112px; width:320px;">
