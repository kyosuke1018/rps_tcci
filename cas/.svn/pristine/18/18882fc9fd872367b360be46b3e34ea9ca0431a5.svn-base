...
<c:if test="${browserType eq 'normal'}" >
    <html>
        <head>
            ...
            <link rel="stylesheet" href="<c:url value="/css/2018_annual_year.css" />" type="text/css" media="screen" />
                ...
                <form:form method="post" id="fm1" cssClass="fm-v clearfix" cssStyle="margin: 0px" commandName="${commandName}" htmlEscape="true">
                    <div class="login">
                        <div class="tagBar">
                            ...
                            <span class="tag">EMP ID</span>
                            <span class="tag">CCIL AD</span>
                        </div>
                        <div class="tcc tab">
                                    ...
                                    <td>
                                        <div class="left" style="margin-right: 10px; margin-left: 5px;">
                                            <select id="companyCode">
                                                <option value="<spring:message code="company.code.1000"/>"><spring:message code="company.code.1000.name"/></option>
                                                <option value="<spring:message code="company.code.5500"/>"><spring:message code="company.code.5500.name"/></option>
                                            </select>
                                            <div class="space"></div>
                                            <img src="images/cm/id.png"/>
                                            ...
                                            <div class="space"></div>
                                            <img src="images/cm/password.png"/>
                                            <input type="password" id="password2" size="12" style="margin-left:2px;"/>
                                        </div>                                    
                                    </td>
                                    <td>
                                        <div class="right" style="margin-right:5px;">
                                            <input style="font-weight: bold;font-size: <spring:message code="screen.tcc_sso.loginbutton.fontsize" />px; font-family:'<spring:message code="screen.tcc_sso.title.font" />';" class="btn-login" id="submit2" name="submit2" accesskey="l" value="<spring:message code="screen.welcome.button.login" />" tabindex="4" type="submit" onclick="usernameConverter()"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
