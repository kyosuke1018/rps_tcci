                            ...
                            <td>
                                <div class="loginField">
                                    ...
                                    <c:if test="${empty sessionScope.openIdLocalId}">
                                        ...
                                        <form:input cssClass="required" cssErrorClass="error" id="username" size="10" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="false" htmlEscape="true" />
                                    </c:if>
                                    ...
                                    <form:password cssClass="required" cssErrorClass="error" id="password" size="10" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" />
                                    <span class="txtRed">
                                        <div id="error">
                                            <form:errors path="*" />
                                        </div>
                                    ...
                                    <div id="login">
                                        <input style="font-weight: bold;" class="btn-submit" name="submit" accesskey="l" value="<spring:message code="screen.welcome.button.login" />" tabindex="3" type="submit" onclick="lowCaseConverter()"/>                            
                                    </div>
                                    <br/>
                                </div>
                            </td>
