                    ...
                    <tr>
                        ...
                        <td>
                            <div class="loginField">
                                ...
                                <div id="message">
                                    <h2 style="color: #0066CC;"><spring:message code="screen.logout.header" /></h2>
                                    <p style="color: #0066CC;"><spring:message code="screen.logout.success" /></p>
                                    <p style="color: #0066CC;"><spring:message code="screen.logout.security" /></p>
                                </div>
                            </div>
                        </td>
                    </tr>			
