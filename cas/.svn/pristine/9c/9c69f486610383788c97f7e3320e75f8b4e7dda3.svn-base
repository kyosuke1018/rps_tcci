...
public class TokenProvider {
    ...
    public void init() {
        ...
        this.tokenValidityForRememberMe = TimeUnit.SECONDS.toMillis(SecurityConstants.REMEMBERME_VALIDITY_SECONDS);   //24 hours
    }

    public String createToken(String username, Set<String> authorities, Boolean rememberMe) {
        logger.debug("TokenProvider　createToken: username:{}, {}", username, rememberMe);
