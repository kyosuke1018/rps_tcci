...
//            int iLength = sNumeric.length();
    ...
    public static int compareTo(BigDecimal valueA, BigDecimal valueB){
        int i = valueA.compareTo(valueB);
        return i;
    }
    //valueA < valueB true
    public static boolean isLessThan(BigDecimal valueA, BigDecimal valueB){
        int i = compareTo(valueA, valueB);
    ...
    //valueA > valueB true
    public static boolean isGreaterThan(BigDecimal valueA, BigDecimal valueB){
        int i = compareTo(valueA, valueB);
    ...
    public static boolean equals(BigDecimal valueA, BigDecimal valueB){
        int i = compareTo(valueA, valueB);
    ...
    public static BigDecimal setDefaultScale(BigDecimal value, int newScale, RoundingMode roundingMode){
        //20150805:檢核Excel數值欄位的精度:小數3位不4捨5入
    ...
    public static String checkValue(String columnName1 ,BigDecimal value1,String columnName2 , BigDecimal value2) {
        String chkMsg = "";
    ...
    public static String checkNotNull(String columnName1 ,BigDecimal value1) {
        String chkMsg = "";
        if(null == value1){
            chkMsg = "["+columnName1+"]不得為空值!";
        }
        return chkMsg;
    }
    public static String checkNotNull(String columnName1 ,Short value1) {
        String chkMsg = "";
        if(null == value1){
            chkMsg = "["+columnName1+"]不得為空值!";
        }
