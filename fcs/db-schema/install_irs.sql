...
--IrsReportBVO (getTotalRe,getTotalPa)
--IrsReportBController(getHighLightColumns,getAutoSizeColumnLength)
--ReportService(processReportBVO,insertFooter,footerTotal,initFooterMap(BS_REPA_COLS, IS_REPA_COLS))
--multi sheet ==> IrsReportBController(postProcessXLSDetail,dTitleLabel(BS_REPA_COLS_HEADER, IS_REPA_COLS_HEADER))
--FC_ACCOUNTS_DETAIL_MAP
