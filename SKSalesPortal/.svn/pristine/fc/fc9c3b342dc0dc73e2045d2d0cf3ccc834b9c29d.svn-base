 ...
 */
@Embeddable
public class ZtabExpVbakPK implements Serializable {
    ...
    public ZtabExpVbakPK() {
    }

    public ZtabExpVbakPK(String mandt, String vbeln) {
        this.mandt = mandt;
        this.vbeln = vbeln;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ZtabExpVbakPK)) {
            return false;
        }
        ZtabExpVbakPK other = (ZtabExpVbakPK) object;
    ...
    public String toString() {
        return "com.tcci.mygui.entity.datawarehouse.ZtabExpVbakPK[ mandt=" + mandt + ", vbeln=" + vbeln + " ]";
    }
