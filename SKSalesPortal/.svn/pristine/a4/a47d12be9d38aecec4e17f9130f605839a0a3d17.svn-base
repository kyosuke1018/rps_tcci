 ...
 */
package com.tcci.worklist.entity;
 ...
 */
@Entity
@Table(name = "SD_ZTAB_EXP_RELFILENO_SD_LOG")
@XmlRootElement
public class ZtabExpRelfilenoSdLog implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @NotNull
    @SequenceGenerator(name = "SEQ_WORKLIST_LOG", sequenceName = "SEQ_WORKLIST_LOG", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_WORKLIST_LOG")
    @Column(name = "ID")
    private Long id;
    @Size(max = 20)
    @Column(name = "MANDT")
    ...
    public ZtabExpRelfilenoSdLog() {
    }

    public ZtabExpRelfilenoSdLog(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ZtabExpRelfilenoSdLog)) {
            return false;
        }
        ZtabExpRelfilenoSdLog other = (ZtabExpRelfilenoSdLog) object;
    ...
    public String toString() {
        return "com.tcci.mygui.entity.datawarehouse.ZtabExpRelfilenoSdLog[ id=" + id + " ]";
    }
