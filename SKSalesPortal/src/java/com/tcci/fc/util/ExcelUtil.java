            ...
            for (int idxCol = 0; idxCol < nCols; idxCol++) {
                ...
                try {
                    ...
                    if (type.getCanonicalName().equals("int")
                            || type.getCanonicalName().equals("short")
                            || type.getCanonicalName().equals("java.lang.Integer")) {
                        Integer value = (Integer) PropertyUtils.getProperty(t, field);
                        cell.setCellValue(value.doubleValue());
                    } else if (type.getCanonicalName().equals("java.lang.Long")) {
                        Long value = (Long) PropertyUtils.getProperty(t, field);
                        cell.setCellValue(value.doubleValue());
                    } else if (type.getCanonicalName().equals("java.lang.Short")) {
                        Short value = (Short) PropertyUtils.getProperty(t, field);
                        cell.setCellValue(value.doubleValue());
                    } else if (type.getCanonicalName().equals("java.math.BigDecimal")) {
                        BigDecimal value = (BigDecimal) PropertyUtils.getProperty(t, field);
                        cell.setCellValue(value.doubleValue());
                    } else {
