 ...
 */
@Embeddable
public class ZtabExpVbkdPK implements Serializable {
    ...
    public ZtabExpVbkdPK() {
    }

    public ZtabExpVbkdPK(String mandt, String vbeln) {
        this.mandt = mandt;
        this.vbeln = vbeln;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ZtabExpVbkdPK)) {
            return false;
        }
        ZtabExpVbkdPK other = (ZtabExpVbkdPK) object;
    ...
    public String toString() {
        return "com.tcci.mygui.entity.datawarehouse.ZtabExpVbkdPK[ mandt=" + mandt + ", vbeln=" + vbeln + " ]";
    }
