 ...
 */
@Embeddable
public class ZtabExpVbukPK implements Serializable {
    ...
    public ZtabExpVbukPK() {
    }

    public ZtabExpVbukPK(String mandt, String vbeln) {
        this.mandt = mandt;
        this.vbeln = vbeln;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ZtabExpVbukPK)) {
            return false;
        }
        ZtabExpVbukPK other = (ZtabExpVbukPK) object;
    ...
    public String toString() {
        return "com.tcci.mygui.entity.datawarehouse.ZtabExpVbukPK[ mandt=" + mandt + ", vbeln=" + vbeln + " ]";
    }
