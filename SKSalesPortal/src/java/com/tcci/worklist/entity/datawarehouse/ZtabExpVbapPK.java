 ...
 */
@Embeddable
public class ZtabExpVbapPK implements Serializable {
    ...
    public ZtabExpVbapPK() {
    }

    public ZtabExpVbapPK(String mandt, String vbeln) {
        this.mandt = mandt;
        this.vbeln = vbeln;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ZtabExpVbapPK)) {
            return false;
        }
        ZtabExpVbapPK other = (ZtabExpVbapPK) object;
    ...
    public String toString() {
        return "com.tcci.mygui.entity.datawarehouse.ZtabExpVbapPK[ mandt=" + mandt + ", vbeln=" + vbeln + " ]";
    }
