...
import com.tcci.tccstore.vo.CrmSODetailVo;
...
public class ZorderCnController implements Serializable  {    
    ...
    private List<CrmSODetailVo> itemsSo = new ArrayList<CrmSODetailVo>();
    ...
    public List<CrmSODetailVo> getItemsSo() {
        return itemsSo;
    }

    public void setItemsSo(List<CrmSODetailVo> itemsSo) {
