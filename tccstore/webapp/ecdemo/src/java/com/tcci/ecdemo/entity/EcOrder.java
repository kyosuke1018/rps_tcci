...
//    @NotNull
    ...
    public EcDelivery getDeliveryId() {
        return deliveryId;
    }

    public void setDeliveryId(EcDelivery deliveryId) {
    ...
    public String toString() {
        return "com.tcci.ecdemo.entity.EcOrder[ id=" + id + " ]";
    }
