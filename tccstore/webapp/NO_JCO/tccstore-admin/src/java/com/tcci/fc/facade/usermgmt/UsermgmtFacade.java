...
public class UsermgmtFacade {
    ...
    /**
     * **********************
     * TcUser Services: save findUserByLoginAccount findAllUser findUserByFilter
     **********************
     */
    ...
    public void save(TcUser user, List<TcGroup> listGroupNew, TcUser operator) {
    ...
    /**
     * **********************
     * TcGroup Services: save findGroup findAllGroup
     **********************
     */
    ...
    /**
     * **********************
     * TcUsergroup Services: save findUsergroup findAllUsergroup
     **********************
     */
    ...
    public TcUsergroup findUsergroup(TcUser tcUser, TcGroup tcGroup) {
        String sql = "SELECT o FROM TcUsergroup o WHERE o.userId=:tcUser ";
        if (tcGroup != null) {
            sql += " AND o.groupId=:tcGroup";
        }
    ...
    public List<TcUsergroup> findUsergroupList (TcUser tcUser) {
        String sql = "SELECT o FROM TcUsergroup o WHERE o.userId=:tcUser ";
        Query q = em.createQuery(sql);
        q.setParameter("tcUser", tcUser);
        List<TcUsergroup> list = q.getResultList();
