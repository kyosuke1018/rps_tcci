...
public class UserSession implements Serializable {
    ...
    private List<EcCustomer> customerList; // member_customer
    ...
    @EJB
    private transient EcCustomerFacade ecCustomerFacade;
...
//        }
        ...
        if (null == ecMember) {
            ...
            customerList = ecCustomerFacade.findByMember(ecMember);
        }
