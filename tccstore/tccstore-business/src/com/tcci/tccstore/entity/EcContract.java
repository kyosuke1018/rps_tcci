...
@NamedQueries({
    ...
    @NamedQuery(name = "EcContract.findByCustomer", query = "SELECT e FROM EcContract e WHERE e.active=TRUE AND e.hide=FALSE AND e.ecCustomer=:ecCustomer ORDER BY e.name")
})
