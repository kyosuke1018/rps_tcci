    ...
    */
    ...
    public List<String> queryDivision(String province, String city) {
        ...
        if (province != null && city != null) {
            ...
            where = " where t1.parent=t2.id and t2.parent=t3.id and t3.name=#province and t2.name=#city and t3.layer=0 and t2.layer=1";
        } else if (province != null) {
            from += ", ec_divisions_cn t2";
            where = " where t1.parent=t2.id and t2.name=#province and t2.layer=0";
        }
