...
"TYPE" NUMBER(1,0) NOT NULL ENABLE, 
"NAME" VARCHAR2(64 CHAR) NOT NULL ENABLE, 
"EMAIL" VARCHAR2(64 CHAR) NOT NULL ENABLE, 
...
CREATE TABLE "EC_NOTIFY_MEMBER" 
(
"NOTIFY_ID" NUMBER(18,0) NOT NULL ENABLE, 
"MEMBER_ID" NUMBER(18,0) NOT NULL ENABLE, 
"READ_TIMESTAMP" DATE, 
CONSTRAINT "EC_NOTIFY_MEMBER_PK" PRIMARY KEY ("NOTIFY_ID", "MEMBER_ID") ENABLE, 
CONSTRAINT "EC_NOTIFY_MEMBER_FK1" FOREIGN KEY ("NOTIFY_ID") REFERENCES "EC_NOTIFY" ("ID") ENABLE, 
CONSTRAINT "EC_NOTIFY_MEMBER_FK2" FOREIGN KEY ("MEMBER_ID") REFERENCES "EC_MEMBER" ("ID") ENABLE
);
COMMENT ON COLUMN "EC_NOTIFY_MEMBER"."NOTIFY_ID" IS 'FK:EC_NOTIFY.ID';
COMMENT ON COLUMN "EC_NOTIFY_MEMBER"."MEMBER_ID" IS 'FK:EC_MEMBER.ID';
COMMENT ON COLUMN "EC_NOTIFY_MEMBER"."READ_TIMESTAMP" IS '讀取時間';
...
-- 客戶銷售組織 
CREATE TABLE "EC_CUSTOMER_VKORG" 
(
"CUSTOMER_ID" NUMBER(18,0) NOT NULL ENABLE,
"VKORG" VARCHAR2(4) NOT NULL ENABLE,
CONSTRAINT "EC_CUSTOMER_VKORG_PK" PRIMARY KEY ("CUSTOMER_ID","VKORG") ENABLE,
CONSTRAINT "EC_CUSTOMER_VKORG_EC_CUST_FK1" FOREIGN KEY ("CUSTOMER_ID") REFERENCES "EC_CUSTOMER" ("ID") ENABLE
);
COMMENT ON COLUMN "EC_CUSTOMER_VKORG"."CUSTOMER_ID" IS 'FK:EC_CUSTOMER.ID';
COMMENT ON COLUMN "EC_CUSTOMER_VKORG"."VKORG" IS '銷售組織';
