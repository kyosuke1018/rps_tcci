...
//    protected TokenProvider tokenProvider;
    ...
    protected @EJB EcOptionFacade ecOptionFacade;
    protected @EJB EtTenderFacade etTenderFacade;
    protected @EJB EtVenderFacade etVenderFacade;
    ...
    public boolean checkVenderPermissions(String method, EcMember member
...
//        }
    ...
    public boolean checkPermissions(String method, EcMember member
...
//        }
     ...
     * @return 
     */
    public String serialize(SubmitVO vo, EcMember operator){
        if( vo==null ){
            return EMPTY_OBJECT;
        }
