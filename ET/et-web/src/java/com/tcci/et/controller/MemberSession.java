...
//            String logoutURL = "logoff.xhtml";
    ...
    public String getDisplayName() {
        return (null == ecMember) ?  adaccount : ecMember.getName();
    }

    // 使用者帳號是否存在於TC_USER資料庫
    public boolean isValid() {
//        return (ecMember != null && !ecMember.getDisabled());
        return (ecMember != null && ecMember.getActive());
    }
    ...
    private void loadUserInfo() {
        ...
        ecMember = ecMemberFacade.findByLoginAccount(adaccount);
        if (null == ecMember) {
