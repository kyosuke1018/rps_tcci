...
//        }
    ...
    private void handleVO(MemberVO vo) {
        EcMember member = ecMemberFacade.findByLoginAccount(vo.getLoginAccount());
        if(member == null){
//            member = new EcMember();
...
//            member.setDisabled(false);
        ...
        ecMemberFacade.save(member, this.getLoginUser(), this.isSimulated());
...
//            String encrypted = aes.encrypt(GlobalConstant.DEF_PWD);
            ...
            //send mail
            ecMemberFacade.sendPwdMail(member, pwd);
        }
        ecMemberFacade.saveVO(vo, this.getLoginUser(), GlobalConstant.DEF_LOCALE.getLocale(), this.isSimulated());
...
//                vo.getMemberId(), true, this.getLoginUser(), this.isSimulated());
    ...
    public void query() {
        try {
            ...
            loaderVOList = ecMemberFacade.findByCriteria(criteriaVO, GlobalConstant.DEF_LOCALE.getLocale());
