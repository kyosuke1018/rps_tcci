...
public class MemberMgnController extends SessionAwareController implements Serializable {
    ...
    @EJB private EcMemberFacade ecMemberFacade;
...
//        selectedVenderList = new ArrayList<>();
    ...
    public void doQuery(){
        ...
        try {
            ...
            List<MemberVO> resList = ecMemberFacade.findByCriteria(criteriaVO, GlobalConstant.DEF_LOCALE.getLocale());
...
//        selectedVenderList = new ArrayList<>();
        ...
        // 取出原 USER 資料
//        editVO = vo;
        editVO = ecMemberFacade.findById(vo.getMemberId(), false, GlobalConstant.DEF_LOCALE.getLocale());
...
//        defPlantUser = true;
    ...
    public void save() {
        ...
        try{
            ...
            ecMemberFacade.saveVO(editVO, this.getLoginUser(), GlobalConstant.DEF_LOCALE.getLocale(), false);
...
//        selectedVenderTxt = "";
    ...
    public void resetPassword(MemberVO vo) {
        ...
        try {
            EcMember member = ecMemberFacade.find(vo.getMemberId());
            ...
            //send mail
            ecMemberFacade.sendPwdMail(member, plaintext);
            
            // save DB
            member.setPassword(encrypted);
            ecMemberFacade.save(member, this.getLoginUser(), false);
