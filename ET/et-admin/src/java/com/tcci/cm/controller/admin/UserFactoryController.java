...
public class UserFactoryController extends SessionAwareController implements Serializable {
     ...
     */
    public void save() {
        logger.info("save"+editUser.getId());
        ...
        // 準備更新工廠關連設定結果
        List<String> selectedFactory = new ArrayList<>();
        ...
        // 準備更新[工廠群組]關連設定結果
        List<String> selectedFactoryGroup = new ArrayList<>();
        List<String> selFactoryGroupCodes = new ArrayList<>();
        ...
        try{
            ...
            cmActivityLogFacade.logActiveCommon(ActivityLogEnum.U_PLANT_PERMISSION, viewId, JsfUtils.getClientIP(), contentSB.toString(), true, this.getLoginUser(), Boolean.FALSE);
            ...
            cmActivityLogFacade.logActiveCommon(ActivityLogEnum.U_PLANT_PERMISSION, viewId, JsfUtils.getClientIP(), contentSB.toString(), false, this.getLoginUser(), Boolean.FALSE);
