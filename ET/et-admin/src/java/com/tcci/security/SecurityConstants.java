...
public class SecurityConstants {
    ...
    public final static String SP_CAS_PREFIX = "com.taiwancement.sso.serverUrlPrefix";
    public final static String SP_CAS_LOGIN = "com.taiwancement.sso.loginUrl";
    ...
    public final static String DEF_VALID_GROUP = "Authenticated";
}
