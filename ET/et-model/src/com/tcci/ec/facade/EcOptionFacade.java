...
public class EcOptionFacade extends AbstractFacade<EcOption> {
     ...
     * @param simulated
     */
    public void save(EcOption entity, TcUser operator, boolean simulated){
        if( entity!=null ){
            // default while null 
    ...
    public void saveVO(OptionVO pubVO, TcUser operator, boolean simulated){
        EcOption entity = (pubVO.getId()!=null)?find(pubVO.getId()):new EcOption();
     ...
     * @param vo
     */
    public void copyEntityToVo(EcOption entity, OptionVO vo){
    ...
    public void copyVoToEntity(OptionVO vo, EcOption entity){
