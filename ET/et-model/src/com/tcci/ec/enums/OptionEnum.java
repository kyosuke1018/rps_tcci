...
public enum OptionEnum {
    ...
    ,AREA("area", "招標地區", null, "EC_OPTION", 1)
    ,TENDER_CATEGORY("tenderCategory", "類別", null, "EC_OPTION", 1)
    ,COMPANY_TYPE("companyType", "供貨商類別", null, "EC_OPTION", 1)
    ,COMPANY_CATEGORY("companyCategory", "供應商行業別", null, "EC_OPTION", 1)
    ,COUNTRY("country", "國別", null, "TC_ZTAB_EXP_T005T", 1)
    ,CURRENCY("currency", "幣別", null, "TC_ZTAB_EXP_TCURT", 1)
    ,INDUSTRY("industry", "幣別", null, "EC_OPTION", 1)
    ;
