...
public enum ValidateStrEnum {
    ...
    EC_COMPANY_CNAME("EC_COMPANY.CNAME", 300, 300, "中文名稱", true),
    EC_COMPANY_ENAME("EC_COMPANY.ENAME", 100, 300, "英文名稱", true),
    EC_COMPANY_ID_TYPE("EC_COMPANY.ID_TYPE", 0, 2, "ID_CODE類別", true),
    EC_COMPANY_ID_CODE("EC_COMPANY.ID_CODE", 16, 50, "統編、營業登記號", true),
    EC_COMPANY_NICKNAME("EC_COMPANY.NICKNAME", 100, 100, "簡稱", true),
    ...
    EC_MEMBER_EMAIL("EC_MEMBER.EMAIL", 21, 64, "電子信箱", true),
    EC_MEMBER_PHONE("EC_MEMBER.PHONE", 16, 50, "電話", false),
    EC_MEMBER_PASSWORD("EC_MEMBER.PASSWORD", 21, 64, "密碼(SHA256)", true),
