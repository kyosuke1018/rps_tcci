...
public class SimulateUser {
    ...
    private void init() {
        try {
            ...
            loginAccount = userSession.getOrigUser().getLoginAccount();
            suguardUrl = jndiGlobalConfig.getProperty("SUGUARD_URL");
//            if (GlobalConstant.DEBUG_MODE) { //要測試模擬申請時再打開
...
//            }
    ...
    public String doSimulate() {
        try {
            ...
            userSession.setNewUserAccount(emuAccount);
            userSession.doSimulateUser();
