...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @SequenceGenerator(name="CM_ACTIVITY_LOG_ID_SEQ",sequenceName = "CM_ACTIVITY_LOG_ID_SEQ", allocationSize=1)       
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CM_ACTIVITY_LOG_ID_SEQ")
