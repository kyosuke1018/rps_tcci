...
CONSTRAINT "ET_MEMBER_PK" PRIMARY KEY ("ID") ENABLE,
CONSTRAINT "ET_MEMBER_UK1" UNIQUE ("LOGIN_ACCOUNT") ENABLE
);
COMMENT ON COLUMN "ET_MEMBER"."ID" IS 'PK';
COMMENT ON COLUMN "ET_MEMBER"."LOGIN_ACCOUNT" IS '登入帳號';
COMMENT ON COLUMN "ET_MEMBER"."NAME" IS '姓名';
COMMENT ON COLUMN "ET_MEMBER"."EMAIL" IS '電子信箱';
COMMENT ON COLUMN "ET_MEMBER"."PHONE" IS '電話';
COMMENT ON COLUMN "ET_MEMBER"."PASSWORD" IS '密碼(SHA256)';
COMMENT ON COLUMN "ET_MEMBER"."APPLY_VENDER_CODE" IS '申請供應商代碼';
COMMENT ON COLUMN "ET_MEMBER"."APPLY_VENDER_NAME" IS '申請供應商名稱';
COMMENT ON COLUMN "ET_MEMBER"."ACTIVE" IS '1:啟用, 0:停用';
COMMENT ON COLUMN "ET_MEMBER"."CREATOR" IS '建立人';
COMMENT ON COLUMN "ET_MEMBER"."CREATETIME" IS '建立時間';
COMMENT ON COLUMN "ET_MEMBER"."MODIFIER" IS '最近修改人';
COMMENT ON COLUMN "ET_MEMBER"."MODIFYTIME" IS '最近修改時間';
COMMENT ON COLUMN "ET_MEMBER"."TYPE" IS '帳號類型(P:個人;C:公司)MemberTypeEnum';    
COMMENT ON COLUMN "ET_MEMBER"."DISABLED" IS '無效';  
COMMENT ON COLUMN "ET_MEMBER"."APPROVETIME" IS '核准時間'; 
COMMENT ON COLUMN "ET_MEMBER"."APPLYTIME" IS '申請時間';   
COMMENT ON COLUMN "ET_MEMBER"."ENAME" IS '英文姓名'; 

CREATE SEQUENCE SEQ_MEMBER INCREMENT BY 1 START WITH 1 NOMAXVALUE CACHE 3 NOORDER  NOCYCLE;

--公司
--drop table ET_COMPANY;
--drop SEQUENCE SEQ_COMPANY;
CREATE TABLE "ET_COMPANY" 
(	"ID" NUMBER(18,0) NOT NULL ENABLE, 
	...
	"MODIFYTIME" DATE, 
	 ...
	 CONSTRAINT "ET_COMPANY_PK" PRIMARY KEY ("ID")
);
COMMENT ON COLUMN "ET_COMPANY"."ID" IS 'PK';
COMMENT ON COLUMN "ET_COMPANY"."TYPE" IS '類型';
COMMENT ON COLUMN "ET_COMPANY"."MAIN_ID" IS '來源主檔ID (by類型)';
COMMENT ON COLUMN "ET_COMPANY"."CODE" IS '公司編號';
COMMENT ON COLUMN "ET_COMPANY"."CNAME" IS '公司中文名稱';
COMMENT ON COLUMN "ET_COMPANY"."ENAME" IS '公司英文名稱';
COMMENT ON COLUMN "ET_COMPANY"."ID_TYPE" IS 'ID_CODE類別';
COMMENT ON COLUMN "ET_COMPANY"."ID_CODE" IS '公司統編 / 稅籍編號';--营业执照编码
COMMENT ON COLUMN "ET_COMPANY"."ID_CODE2" IS '統編、營業登記號';--税务登记证号
COMMENT ON COLUMN "ET_COMPANY"."ID_CODE3" IS '統編、營業登記號';--经营许可证号
COMMENT ON COLUMN "ET_COMPANY"."ID_CODE4" IS '統編、營業登記號';--组织机构代码
COMMENT ON COLUMN "ET_COMPANY"."ID_CODE5" IS '統編、營業登記號';
COMMENT ON COLUMN "ET_COMPANY"."NICKNAME" IS '簡稱';
COMMENT ON COLUMN "ET_COMPANY"."BRIEF" IS '簡介';--经营范围
COMMENT ON COLUMN "ET_COMPANY"."BRIEF2" IS '簡介2(主要產品)';--经营业绩
COMMENT ON COLUMN "ET_COMPANY"."BRIEF3" IS '簡介3(代理品牌	)';--企业介绍
COMMENT ON COLUMN ET_COMPANY.TEL1 IS '電話1(公司登記電話)';--固定电话
COMMENT ON COLUMN ET_COMPANY.TEL2 IS '電話2(聯絡人電話)';
COMMENT ON COLUMN ET_COMPANY.TEL3 IS '電話3(聯絡人手機)';
COMMENT ON COLUMN ET_COMPANY.TEL4 IS '電話4(聯絡傳真)';
COMMENT ON COLUMN ET_COMPANY.OWNER1 IS '負責人1';--法人代表
COMMENT ON COLUMN ET_COMPANY.OWNER2 IS '負責人2(聯絡人)';
COMMENT ON COLUMN ET_COMPANY.OWNER1_TITLE IS '負責人1職稱';
COMMENT ON COLUMN ET_COMPANY.OWNER2_TITLE IS '負責人2職稱(聯絡人職稱)';
COMMENT ON COLUMN ET_COMPANY.COUNTRY IS '國別';
COMMENT ON COLUMN ET_COMPANY.STATE IS '州、省(所在區域)';
COMMENT ON COLUMN "ET_COMPANY"."ZIP1" IS '郵遞區號';--邮政编码
COMMENT ON COLUMN "ET_COMPANY"."ZIP2" IS '郵遞區號';--邮政编码
COMMENT ON COLUMN "ET_COMPANY"."ADDR1" IS '地址1(公司登記地址)';--公司注册地
COMMENT ON COLUMN "ET_COMPANY"."ADDR2" IS '地址2(聯絡地址)';--办公地址
COMMENT ON COLUMN ET_COMPANY.URL1 IS '公司網站';
COMMENT ON COLUMN ET_COMPANY.URL2 IS '聯絡人電子信箱';
COMMENT ON COLUMN ET_COMPANY.START_AT IS '公司創立日期';
COMMENT ON COLUMN ET_COMPANY.CATEGORY IS '分類';--分類
COMMENT ON COLUMN ET_COMPANY.INDUSTRY IS '供應商行業別';
COMMENT ON COLUMN ET_COMPANY.CAPITAL IS '資本額';--注册资金
COMMENT ON COLUMN ET_COMPANY.YEAR_REVENUE IS '年營業額';
COMMENT ON COLUMN ET_COMPANY.EMPLOYEE IS '員工人數';
COMMENT ON COLUMN ET_COMPANY.CURRENCY IS '訂單幣別';
COMMENT ON COLUMN "ET_COMPANY"."BANK1" IS '銀行名稱 / 分行';--开户行
COMMENT ON COLUMN "ET_COMPANY"."BANK2" IS '銀行2';--
COMMENT ON COLUMN "ET_COMPANY"."BANK1_BENEFICIARY" IS '受款人1';
COMMENT ON COLUMN "ET_COMPANY"."BANK2_BENEFICIARY" IS '受款人2';
COMMENT ON COLUMN "ET_COMPANY"."BANK1_CODE" IS '銀行代號 (金資代碼)1';
COMMENT ON COLUMN "ET_COMPANY"."BANK2_CODE" IS '銀行代號 (金資代碼)2';
COMMENT ON COLUMN "ET_COMPANY"."BANK1_ACCOUNT" IS '銀行帳號1';
COMMENT ON COLUMN "ET_COMPANY"."BANK2_ACCOUNT" IS '銀行帳號2';
COMMENT ON COLUMN "ET_COMPANY"."BANK1_ADDR" IS '銀行地址1';
COMMENT ON COLUMN "ET_COMPANY"."BANK2_ADDR" IS '銀行地址2';
COMMENT ON COLUMN ET_COMPANY.CREATOR IS '建立者';
COMMENT ON COLUMN ET_COMPANY.CREATETIME IS '建立時間';
COMMENT ON COLUMN ET_COMPANY.MODIFIER IS '最近修改人';
COMMENT ON COLUMN ET_COMPANY.MODIFYTIME IS '最近修改時間';
...
CREATE TABLE "ET_OPTION" 
   ...
   "ID" NUMBER(18,0) NOT NULL ENABLE, 
	...
	"STORE_ID" NUMBER(18,0), 
	 CONSTRAINT "ET_OPTION_PK" PRIMARY KEY ("ID")
   )
COMMENT ON COLUMN "ET_OPTION"."ID" IS 'PK ID';
   COMMENT ON COLUMN "ET_OPTION"."TYPE" IS '類別';
   COMMENT ON COLUMN "ET_OPTION"."CNAME" IS '中文名稱';
   COMMENT ON COLUMN "ET_OPTION"."ENAME" IS '英文名稱';
   COMMENT ON COLUMN "ET_OPTION"."CODE" IS '代碼';
   COMMENT ON COLUMN "ET_OPTION"."PARENT" IS '上層ID';
   COMMENT ON COLUMN "ET_OPTION"."MEMO" IS '備註';
   COMMENT ON COLUMN "ET_OPTION"."LEVELNUM" IS '階層';
   COMMENT ON COLUMN "ET_OPTION"."SORTNUM" IS '排序';
   COMMENT ON COLUMN "ET_OPTION"."DISABLED" IS '無效';
   COMMENT ON COLUMN "ET_OPTION"."READONLY" IS '唯讀';
   COMMENT ON COLUMN "ET_OPTION"."CREATOR" IS '建立者';
   COMMENT ON COLUMN "ET_OPTION"."CREATETIME" IS '建立時間';
   COMMENT ON COLUMN "ET_OPTION"."MODIFIER" IS '最近修改人';
   COMMENT ON COLUMN "ET_OPTION"."MODIFYTIME" IS '最近修改時間';
   COMMENT ON COLUMN "ET_OPTION"."STORE_ID" IS '商店ID';
   COMMENT ON TABLE "ET_OPTION"  IS '簡單選項主檔';
CREATE SEQUENCE SEQ_OPTION INCREMENT BY 1 START WITH 1 NOMAXVALUE CACHE 3 NOORDER  NOCYCLE;
  ...
  CREATE TABLE "ET_FILE" 
   ...
   COMMENT ON COLUMN "ET_FILE"."ID" IS 'PK ID';
   COMMENT ON COLUMN "ET_FILE"."PRIMARY_TYPE" IS '對應主關聯類別(Class Name or FileEnum)';
   COMMENT ON COLUMN "ET_FILE"."PRIMARY_ID" IS '對應主關聯檔ID';
   COMMENT ON COLUMN "ET_FILE"."NAME" IS '顯示名稱';
   COMMENT ON COLUMN "ET_FILE"."DESCRIPTION" IS '說明';
   COMMENT ON COLUMN "ET_FILE"."FILENAME" IS '原檔名';
   COMMENT ON COLUMN "ET_FILE"."SAVENAME" IS '儲存檔名';
   COMMENT ON COLUMN "ET_FILE"."SAVEDIR" IS '儲存路徑';
   COMMENT ON COLUMN "ET_FILE"."CREATOR" IS '建立者';
   COMMENT ON COLUMN "ET_FILE"."CREATETIME" IS '建立時間';
   COMMENT ON COLUMN "ET_FILE"."MODIFIER" IS '最近修改人';
   COMMENT ON COLUMN "ET_FILE"."MODIFYTIME" IS '最近修改時間';
   COMMENT ON COLUMN "ET_FILE"."CONTENT_TYPE" IS '檔案類型';
   COMMENT ON COLUMN "ET_FILE"."FILESIZE" IS '檔案大小bytes';
   COMMENT ON TABLE "ET_FILE"  IS '上傳檔案主檔';
CREATE SEQUENCE SEQ_FILE INCREMENT BY 1 START WITH 1 NOMAXVALUE CACHE 3 NOORDER  NOCYCLE;


CREATE TABLE "ET_USE_LOG" 
   (	
   "ID" NUMBER(18,0) NOT NULL ENABLE, 
   ...
   COMMENT ON COLUMN "ET_USE_LOG"."ID" IS 'PK ID';
   COMMENT ON COLUMN "ET_USE_LOG"."TYPE" IS 'LOG分類 (LogTypeEnum)';
   COMMENT ON COLUMN "ET_USE_LOG"."CATEGORY" IS '細部分類代碼 (LogCateforyEnum)';
   COMMENT ON COLUMN "ET_USE_LOG"."MEMBER_ID" IS '操作人ET_MEMBER.ID';
   COMMENT ON COLUMN "ET_USE_LOG"."PERIOD" IS '期間(秒)';
   COMMENT ON COLUMN "ET_USE_LOG"."SRC" IS '來源 (WEB、APP)';
   COMMENT ON COLUMN "ET_USE_LOG"."CLIENT_IP" IS 'Client IP';
   COMMENT ON COLUMN "ET_USE_LOG"."CLIENT_INFO" IS '其他用戶端資訊(JSON格式)';
   COMMENT ON COLUMN "ET_USE_LOG"."MEMO" IS '備註';
   COMMENT ON COLUMN "ET_USE_LOG"."CREATOR" IS '建立人';
   COMMENT ON COLUMN "ET_USE_LOG"."CREATETIME" IS '建立時間';
   COMMENT ON COLUMN "ET_USE_LOG"."MODIFIER" IS '最近修改人';
   COMMENT ON COLUMN "ET_USE_LOG"."MODIFYTIME" IS '最近修改時間';
   COMMENT ON COLUMN "ET_USE_LOG"."PATROL_LATITUDE" IS '緯度';
   COMMENT ON COLUMN "ET_USE_LOG"."PATROL_LONGITUDE" IS '經度';
   COMMENT ON TABLE "ET_USE_LOG"  IS '使用記錄';
...
COMMENT ON COLUMN "ET_VENDER"."ID" IS 'PK ID';
   COMMENT ON COLUMN "ET_VENDER"."MAIN_ID" IS 'ET_MEMBER_ID';
...
join ET_OPTION o on o.id = A.CATEGORY AND o.TYPE = 'tenderCategory'
