...
CREATE TABLE TC_PROCESS (
  ...
  TERMINATE_REASON VARCHAR2(500 CHAR),
...
CREATE TABLE "TC_REASSIGN_CONF" 
(
"ID" NUMBER(18,0) NOT NULL ENABLE, 
"OWNER" NUMBER(18,0) NOT NULL ENABLE, 
"NEWOWNER" NUMBER(18,0), 
"STARTTIME" DATE, 
"ENDTIME" DATE, 
"COMMENTS" VARCHAR2(100 CHAR), 
"ENABLE" NUMBER(1,0) DEFAULT 1 NOT NULL ENABLE, 
"MODIFYTIME" DATE DEFAULT sysdate NOT NULL ENABLE, 
"PROCESSNAME" VARCHAR2(255 CHAR) ,
CONSTRAINT "TC_REASSIGN_CONF_PK" PRIMARY KEY ("ID") ENABLE, 
CONSTRAINT "TC_REASSIGN_CONF_FK1" FOREIGN KEY ("OWNER") REFERENCES "TC_USER" ("ID") ENABLE, 
CONSTRAINT "TC_REASSIGN_CONF_FK2" FOREIGN KEY ("NEWOWNER") REFERENCES "TC_USER" ("ID") ENABLE
);
COMMENT ON COLUMN "TC_REASSIGN_CONF"."ID" IS 'PK';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."STARTTIME" IS '改派開始時間';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."ENDTIME" IS '改派結束時間';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."COMMENTS" IS '說明';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."ENABLE" IS '1:啟用 0:停用';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."MODIFYTIME" IS '修改時間';
COMMENT ON COLUMN "TC_REASSIGN_CONF"."PROCESSNAME" IS '流程名稱(空白則不指定)';
