...
public class UsermgmtController implements Serializable {
    ...
    private List<TcGroup> groupSelected; // group.id
        ...
        if (null == user) {
            ...
            if (ugColl != null && !ugColl.isEmpty()) {
                for (TcUsergroup ug : ugColl) {
                    groupSelected.add(ug.getGroupId());
                }
            }
        }
    }
    ...
    public void saveUser() {
        ...
        List<TcGroup> listGroupNew = new ArrayList<TcGroup>(groupSelected);
        /*
    ...
    public List<TcGroup> getGroupSelected() {
        return groupSelected;
    }

    public void setGroupSelected(List<TcGroup> groupSelected) {
