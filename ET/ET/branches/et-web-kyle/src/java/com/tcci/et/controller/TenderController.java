...
import com.tcci.et.facade.rs.MemberREST;
import com.tcci.et.facade.rs.TenderREST;
...
public class TenderController extends SessionAwareController implements Serializable {
    ...
    private List<MemberVenderVO> venderList;//會員綁定 供應商類別符合
...
//            String url = "http://localhost:8080/et-web/services/tender/full" + "/" + id;
    ...
    private List<MemberVenderVO> findMatchVenderList(SubmitVO formVO){
        try{
...
//                        attachmentVO.getInputStream(),
    ...
    public List<MemberVenderVO> getVenderList() {
        return venderList;
    }
