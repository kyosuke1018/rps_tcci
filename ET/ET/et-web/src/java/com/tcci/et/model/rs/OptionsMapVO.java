...
public class OptionsMapVO extends BaseResponseVO {
    ...
    // 獨立 Table
    private List<LongOptionVO> factorys;
//    private PrdTypeTreeVO prdTypeTree;
    ...
    private List<StrOptionVO> country;
    private List<StrOptionVO> currency;
    // ET_OPTION
    private List<LongOptionVO> area;
    private List<LongOptionVO> tenderCategory;
    private List<LongOptionVO> companyType;
    private List<LongOptionVO> companyCategory;
//    private List<LongOptionVO> country;
...
//    }
    ...
    public List<LongOptionVO> getArea() {
        return area;
    }

    public void setArea(List<LongOptionVO> area) {
        this.area = area;
    }

    public List<LongOptionVO> getTenderCategory() {
        return tenderCategory;
    }

    public void setTenderCategory(List<LongOptionVO> tenderCategory) {
        this.tenderCategory = tenderCategory;
    }

    public List<LongOptionVO> getCompanyType() {
        return companyType;
    }

    public void setCompanyType(List<LongOptionVO> companyType) {
        this.companyType = companyType;
    }

    public List<LongOptionVO> getCompanyCategory() {
        return companyCategory;
    }

    public void setCompanyCategory(List<LongOptionVO> companyCategory) {
        this.companyCategory = companyCategory;
    }

    public List<StrOptionVO> getCountry() {
        return country;
    }

    public void setCountry(List<StrOptionVO> country) {
        this.country = country;
    }

    public List<StrOptionVO> getCurrency() {
        return currency;
    }

    public void setCurrency(List<StrOptionVO> currency) {
        this.currency = currency;
    }

    public List<LongOptionVO> getFactorys() {
        return factorys;
    }

    public void setFactorys(List<LongOptionVO> factorys) {
