package com.tcci.et.rfq.report.prReport;

import com.tcci.et.rfq.report.priceLog.*;
...
@ManagedBean(name = "prReportController")
@ViewScoped
public class PrReportController extends SessionAwareController implements Serializable {

    public static final long FUNC_OPTION = 53;
