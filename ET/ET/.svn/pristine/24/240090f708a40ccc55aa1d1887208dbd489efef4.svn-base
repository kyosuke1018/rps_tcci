...
import com.tcci.et.entity.EtRfqEkkotx;
import com.tcci.et.model.rfq.RfqEkkotxVO;
 ...
 */
@Stateless
public class EtRfqEkkotxFacade extends AbstractFacade<EtRfqEkkotx> {
    ...
    public EtRfqEkkotxFacade() {
        super(EtRfqEkkotx.class);
    }
    
    public void remove(QuotationVO vo, boolean simulated) {       
        EtRfqEkkotx entity = findByVO(vo);
    ...
    public EtRfqEkkotx findByVO(QuotationVO vo){
        EtRfqEkkotx entity = this.find(vo.getId());
        return entity;
    }
    /**
     * 單筆儲存
     ...
     * @param simulated
     */
    public void save(EtRfqEkkotx entity, TcUser operator, boolean simulated){
        if( entity!=null ){
            // default while null 
    ...
    public void saveVO(QuotationVO vo, TcUser operator, boolean simulated){
        ...
        EtRfqEkkotx entity = (vo.getId()!=null)?this.find(vo.getId()):new EtRfqEkkotx();
     ...
     * @return 
     */
    public List<RfqEkkotxVO> findByCriteria(RfqCriteriaVO criteriaVO){
        Map<String, Object> params = new HashMap<String, Object>();
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT S.* \n");
        ...
        List<RfqEkkotxVO> list = null;
        list = this.selectBySql(RfqEkkotxVO.class, sql.toString(), params, criteriaVO.getFirstResult(), criteriaVO.getMaxResults());
        return list;
    }
    ...
    public RfqEkkotxVO findById(Long id, boolean fullData) {
        ...
        List<RfqEkkotxVO> list = findByCriteria(criteriaVO);
