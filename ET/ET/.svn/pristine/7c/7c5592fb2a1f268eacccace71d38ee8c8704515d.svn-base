...
public class MemberVO extends BaseResponseVO implements IOperator, Serializable {
    ...
    // for ET_MEMBER
    @InputCheckMeta(key="ET_MEMBER.LOGIN_ACCOUNT")
    private String loginAccount;
//    private String password;
    private String pwd;//for new 匯入會員 不能用password當變數
    @InputCheckMeta(key="ET_MEMBER.NAME")
    private String name;
    @InputCheckMeta(key="ET_MEMBER.EMAIL")
    private String email;
//    @InputCheckMeta(key="ET_MEMBER.PHONE")
