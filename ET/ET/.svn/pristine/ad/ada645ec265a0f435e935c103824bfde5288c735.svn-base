...
public enum ValidateStrEnum {
    ...
    ET_COMPANY_TYPE("ET_COMPANY.TYPE", 6, 20, "類型", true),
    ET_COMPANY_CNAME("ET_COMPANY.CNAME", 300, 300, "中文名稱", true),
    ET_COMPANY_ENAME("ET_COMPANY.ENAME", 100, 300, "英文名稱", true),
    ET_COMPANY_ID_TYPE("ET_COMPANY.ID_TYPE", 0, 2, "ID_CODE類別", true),
    ET_COMPANY_ID_CODE("ET_COMPANY.ID_CODE", 16, 50, "統編、營業登記號", true),
    ET_COMPANY_NICKNAME("ET_COMPANY.NICKNAME", 100, 100, "簡稱", true),
    ET_COMPANY_BRIEF("ET_COMPANY.BRIEF", 500, 500, "簡介", true),
    ET_COMPANY_EMAIL1("ET_COMPANY.EMAIL1", 33, 100, "電郵1", true),
    ET_COMPANY_EMAIL2("ET_COMPANY.EMAIL2", 33, 100, "電郵2", true),
    ET_COMPANY_EMAIL3("ET_COMPANY.EMAIL3", 33, 100, "電郵3", true),
    ET_COMPANY_TEL1("ET_COMPANY.TEL1", 10, 30, "電話1", true),
    ET_COMPANY_TEL2("ET_COMPANY.TEL2", 10, 30, "電話2", true),
    ET_COMPANY_TEL3("ET_COMPANY.TEL3", 10, 30, "電話3", true),
    ET_COMPANY_FAX1("ET_COMPANY.FAX1", 10, 30, "傳真1", true),
    ET_COMPANY_FAX2("ET_COMPANY.FAX2", 10, 30, "傳真2", true),
    ET_COMPANY_ADDR1("ET_COMPANY.ADDR1", 500, 500, "地址1", true),
    ET_COMPANY_ADDR2("ET_COMPANY.ADDR2", 500, 500, "地址2", true),
    ET_COMPANY_OWNER1("ET_COMPANY.OWNER1", 33, 100, "負責人1", true),
    ET_COMPANY_OWNER2("ET_COMPANY.OWNER2", 33, 100, "負責人1", true),
    ET_COMPANY_CONTACT1("ET_COMPANY.CONTACT1", 33, 100, "聯絡人1", true),
    ET_COMPANY_CONTACT2("ET_COMPANY.CONTACT2", 33, 100, "聯絡人2", true),
    ET_COMPANY_CONTACT3("ET_COMPANY.CONTACT3", 33, 100, "聯絡人3", true),
    ET_COMPANY_WEB_ID1("ET_COMPANY.WEB_ID1", 10, 30, "微信帳號", true),
    ET_COMPANY_WEB_ID2("ET_COMPANY.WEB_ID2", 10, 30, "社群帳號", true),
    ET_COMPANY_LONGITUDE("ET_COMPANY.LONGITUDE", 6, 20, "經度", true),
    ET_COMPANY_LATITUDE("ET_COMPANY.LATITUDE", 6, 20, "緯度", true),
    ET_COMPANY_URL1("ET_COMPANY.URL1", 340, 1024, "網址1", true),
    ET_COMPANY_URL2("ET_COMPANY.URL2", 340, 1024, "網址2", true),
    ...
    ET_FILE_PRIMARY_TYPE("ET_FILE.PRIMARY_TYPE", 16, 50, "對應主關聯類別", false),
    ET_FILE_NAME("ET_FILE.NAME", 600, 600, "顯示名稱", true),
    ET_FILE_DESCRIPTION("ET_FILE.DESCRIPTION", 600, 600, "說明", true),
    ET_FILE_FILENAME("ET_FILE.FILENAME", 600, 600, "原檔名", true),
    ET_FILE_SAVENAME("ET_FILE.SAVENAME", 16, 50, "儲存檔名", false),
    ET_FILE_SAVEDIR("ET_FILE.SAVEDIR", 33, 100, "儲存路徑", true),
    ET_FILE_CONTENT_TYPE("ET_FILE.CONTENT_TYPE", 33, 100, "檔案類型", true),
    ...
    ET_MEMBER_LOGIN_ACCOUNT("ET_MEMBER.LOGIN_ACCOUNT", 16, 50, "會員帳號", false),
    ET_MEMBER_NAME("ET_MEMBER.NAME", 64, 64, "姓名", false),
    ET_MEMBER_EMAIL("ET_MEMBER.EMAIL", 21, 64, "電子信箱", true),
    ET_MEMBER_PHONE("ET_MEMBER.PHONE", 16, 50, "電話", false),
    ET_MEMBER_PASSWORD("ET_MEMBER.PASSWORD", 21, 64, "密碼(SHA256)", true),
    ET_MEMBER_TYPE("ET_MEMBER.TYPE", 10, 30, "帳號類型", true), //(P:個人;C:公司)MemberTypeEnum
    
    ET_MEMBER_MSG_TYPE("ET_MEMBER.TYPE", 1, 3, "類別", true),
    ET_MEMBER_MSG_MESSAGE("ET_MEMBER.MESSAGE", 500, 500, "留言內容", false),
    
    ET_OPTION_TYPE("ET_OPTION.TYPE", 10, 30, "類別", false),
    ET_OPTION_CNAME("ET_OPTION.CNAME", 200, 200, "中文名稱", false),
    ET_OPTION_ENAME("ET_OPTION.ENAME", 66, 200, "英文名稱", true),
    ET_OPTION_CODE("ET_OPTION.CODE", 33, 100, "代碼", true),
    ET_OPTION_MEMO("ET_OPTION.MEMO", 100, 300, "備註", true),
