...
public class QuotePmRsVO implements Serializable {
    ...
    //private BigDecimal rfqTbtwr; // 單價(RFQ)
    //private String rfqWaers; // 幣別碼(RFQ)
    //private BigDecimal rfqNetwr; // 總價(RFQ)
    ...
    public QuotePmRsVO(Long id) {
        this.id = id;
    }

    public QuotePmRsVO(Long id, Long tenderId, Long rfqId, Long quoteId, String mandt, Long ebelp, BigInteger extrow) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QuotePmRsVO)) {
            return false;
        }
        QuotePmRsVO other = (QuotePmRsVO) object;
    ...
    public String toString() {
        return "com.tcci.et.model.rs.QuotePmRsVO[ id=" + id + " ]";
    }
