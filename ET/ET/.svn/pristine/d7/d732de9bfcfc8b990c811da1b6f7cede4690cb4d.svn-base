...
public enum ActivityLogEnum {
    //A
    A_MEMBER("A11", "新增會員", "ET_MEMBER"),
    U_MEMBER("A11", "修改會員", "ET_MEMBER"),
    RESET_PWD("A11", "重設密碼", "ET_MEMBER"),
    ...
    A_OPTION("S21", "新增系統選項", "ET_OPTION"),
    U_OPTION("S22", "修改系統選項", "ET_OPTION"),
    D_OPTION("S23", "刪除系統選項", "ET_OPTION"),
    
    U_FUNC_PERMISSION("S2", "變更功能權限", "TC_USERGROUP"),
    U_PLANT_PERMISSION("S3", "變更廠別權限", "CM_USERFACTORY"),
    U_USER_IMPORT("S5", "匯入使用者", "TC_USER"),
    U_MEMBER_IMPORT("S7", "匯入會員", "ET_MEMBER"),
    ;
