...
public class FactoryGroupController extends SessionAwareController implements Serializable {
    ...
    // private boolean showOilPricingFields = false;
    ...
    public void initInput(){
        ...
        // 顯示 幣別、單位
        //showOilPricingFields = FactoryGroupTypeEnum.OILAREA.getCode().equals(editGroup.getGrouptype());
    ...
    public void deleteGroup(){
        if( cmFactorygroup!=null ){
            ...
            cmFactorygroupFacade.remove(cmFactorygroup, Boolean.FALSE);
