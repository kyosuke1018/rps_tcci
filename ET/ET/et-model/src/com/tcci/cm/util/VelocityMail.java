...
public class VelocityMail {
    ...
    public static void sendMail(HashMap parameters, Object bean, String template) {
        sendMail(parameters, bean, template, null);
    }
     ...
     * @param attachment 
     */
    public static void sendMail(HashMap parameters, Object bean, String template, Properties attachment) {
        if (parameters == null) {
            return;
        }
