 ...
 */
@Stateless
public class EtMemberVenderFacade extends AbstractFacade<EtMemberVender> {
    ...
    public EtMemberVenderFacade() {
        super(EtMemberVender.class);
    }
     ...
     * @param simulated
     */
    public void save(EtMemberVender entity, TcUser operator, boolean simulated){
        if( entity!=null ){
...
//        }
    ...
    public String findByCriteriaSQL(BaseCriteriaVO criteriaVO, Map<String, Object> params){
        StringBuilder sql = new StringBuilder();
        sql.append("FROM ET_MEMBER_VENDER S \n");
...
//        }
    ...
    public List<MemberVenderVO> findByMemberId(Long memberId){
        BaseCriteriaVO criteriaVO = new BaseCriteriaVO();
    ...
    public List<EtMemberVender> findByMainId(Long mainId){
        Query q = em.createNamedQuery("EtMemberVender.findByMainId");
        q.setParameter("mainId", mainId);
        return q.getResultList();
    }
    
    public List<MemberVenderVO> findLfa1ByCriteria(BaseCriteriaVO criteriaVO){
        Map<String, Object> params = new HashMap<>();
        StringBuilder sql = new StringBuilder();
...
//        logger.info("findLfa1ByCriteria sql = "+sql.toString());
    ...
    public String findLfa1ByCriteriaSQL(BaseCriteriaVO criteriaVO, Map<String, Object> params){
        ...
        if( countOnly ){
            ...
            sql.append("SELECT  \n");
            sql.append("distinct S.MANDT, S.LIFNR, S.LIFNR_UI venderCode, S.NAME1 CNAME \n");
        }
