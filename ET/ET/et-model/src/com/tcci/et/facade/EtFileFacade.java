 ...
 */
@Stateless
public class EtFileFacade extends AbstractFacade<EtFile> {
     ...
     * @param simulated
     */
    public void save(EtFile entity, EtMember operator, boolean simulated){
        if( entity!=null ){
   ...
   public List<FileVO> findByIds(Long storeId, String primaryType, Long primaryId, List<Long> idList){
    ...
    public EtFile findEntityByPrimary(String primaryType, Long primaryId){
        if( primaryType==null || primaryId==null ){
        ...
        List<EtFile> list = this.findByNamedQuery("EtFile.findByPrimary", params);
    ...
    public boolean checkInput(EtFile entity, EtMember member, Locale locale, List<String> errors) {
        boolean pass = true;
