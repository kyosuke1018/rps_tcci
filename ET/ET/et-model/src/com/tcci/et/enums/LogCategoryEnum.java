...
public enum LogCategoryEnum {
    ...
    //會員功能
    RESET_PWD("RESET_PWD", "重設密碼", LogTypeEnum.FUNC_WEB),
    CHANGE_PWD("CHANGE_PWD", "變更密碼", LogTypeEnum.FUNC_WEB),
    // 賣家功能
    ...
    IMP_DEALER("importDealer.html", "匯入台泥經銷商", LogTypeEnum.FUNC_ADMIN_WEB),
