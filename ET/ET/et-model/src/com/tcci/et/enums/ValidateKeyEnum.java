...
public enum ValidateKeyEnum {
    ...
    ET_MEMBER_LOGIN_ACCOUNT("ET_MEMBER.LOGIN_ACCOUNT", "會員帳號", true, false, false, false, false)
    
    , ET_OPTION_CNAME("ET_OPTION.CNAME", "中文名稱", false, true, false, false, true)
    , ET_OPTION_ENAME("ET_OPTION.ENAME", "英文名稱", false, true, false, false, true)
