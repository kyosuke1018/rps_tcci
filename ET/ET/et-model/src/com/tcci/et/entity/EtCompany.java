 ...
 */
@Entity
@Table(name = "ET_COMPANY")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EtCompany.findAll", query = "SELECT e FROM EtCompany e")
    , @NamedQuery(name = "EtCompany.findById", query = "SELECT e FROM EtCompany e WHERE e.id = :id")
    , @NamedQuery(name = "EtCompany.findByType", query = "SELECT e FROM EtCompany e WHERE e.type = :type")})
public class EtCompany implements Serializable {
    ...
    private String type;
    @Column(name = "MAIN_ID")
    private Long mainId;//ET_MEMBER.ID
    @Column(name = "CODE")
    private String code;
    @Column(name = "CNAME")
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EtCompany)) {
            return false;
        }
        EtCompany other = (EtCompany) object;
    ...
    public String toString() {
        return "com.tcci.et.entity.EtCompany[ id=" + id + " ]";
    }
